...
class shopListfeaturesPlugin extends shopPlugin
{
    ...
    public static function settingsCopySetOptions($name, $params)
    {
        return (string) new waLazyDisplay(new shopListfeaturesPluginSettingsControlCopySetOptionsAction(
            array(
                'set_id' => $params['value'],
            )
        ));
